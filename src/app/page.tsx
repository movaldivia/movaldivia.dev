      ...
      <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
        ...
        <div className="lg:order-first lg:row-span-2">
          ...
          <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
            <p>Hi!</p>
            <p>
              I'm Mauricio, a passionate software engineer. I have programmed
              many different things, from a simple hello world to smart
              contracts. What I love about programming is that you don't have
              limits in your creation. You need a laptop with an internet
              connection and your own time.
            </p>
            <p>
...
const projects = [
  ...
  },
  {
    name: 'Reity',
    description:
      "Buy percentages of Chile's real estate using blockchain technology.",
